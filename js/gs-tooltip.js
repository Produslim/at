$(document).ready(function() {
	...
	function CheckPhoneNumber(phone, country) {
		...
		switch (country) {
		  ...
		  case 'DE':
			regex = /^(\+)?49(\s)?(\d){5,13}$/;
			error_msg = 'Bitte geben Sie eine gültige Telefonnummer ein. Die Telefonnummer sollte 7-13 Ziffern enthalten und mit 49 beginnen. Zum Beispiel: 49912345678.';
			break;
		  ...
		  case 'RO':
			regex = /^(\+)?40(\s)?(\d){6,9}$/;
			error_msg = 'Vă rugăm să introduceți un număr de telefon valid. Numărul de telefon trebuie să conțină 8-11 cifre și să înceapă cu 40. De Exemplu: 40212345678.';
			break;
